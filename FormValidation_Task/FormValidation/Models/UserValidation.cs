using FormValidation.SupportiveAnnotations;
using System;
...
namespace FormValidation.Models
{
    public class UserValidation
    {
        ...
        [RegularExpression("^[1-9][0-9]-[0-9][0-9][0-9][0-9][0-9]-[1-3]+", ErrorMessage = "Please enter your aiub id")]
        public string aiubid { get; set; }

        [Display(Name = "AIUB Mail")]
        [Required(ErrorMessage = "xx-xxxxx-x@student.aiub.edu mail is required.")]
        [RegularExpression("^[1-9][0-9]-[0-9][0-9][0-9][0-9][0-9]-[1-3]@student.aiub.edu+", ErrorMessage = "Please enter your aiub mail")]
        [IdMatchEmailValidation(OtherProperty = "aiubid")]
...
/*        [Display(Name = "Gender")]
        ...
        [RegularExpression("^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}$", ErrorMessage = "Please maintain 2 uppercase, 2 special charater and 1 number with minimum 8 digits")]
